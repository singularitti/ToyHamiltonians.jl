...
[discuss with us](https://github.com/singularitti/ToyHamiltonians.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/singularitti/ToyHamiltonians.jl/issues/new) or
[submit a pull request](https://github.com/singularitti/ToyHamiltonians.jl/compare) with suggestions.
